...
pattern = re.compile(
    r'<div class="font-display font-bold text-2xl text-slate-900">\s*'
...
for filename in files:
    ...
    replacement = f"""<a href="{target_link}" class="font-display font-bold text-2xl text-slate-900 hover:opacity-80 transition cursor-pointer">
...
print("Footer logo wrapped in a tags.")
